...
//        {
//            _Report report = new _Report() { /*Устанавливаем режим отчета: true - расширенный, false - обычный*/ compliteReport = true };
...
//            for (int i = 0; i < reportComp.Count; i++)
//            {
//                if (reportComp[i].Type == _zagotType)
//                {
//                    Material part = reportComp.FirstOrDefault(e => e.Type == _partType && e.MaterialId == reportComp[i].MaterialId);
//                    int partInd = reportComp.IndexOf(part);
