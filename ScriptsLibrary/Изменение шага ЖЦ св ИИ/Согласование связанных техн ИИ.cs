//Согласование связанных техн ИИ
...
public class Script
{
    ...
    public void Execute(IActivity activity)
    {
                    ...
                    for (int i = 0; i < techIIs.Count; i++)
                    {
                        ...
                        if (II.LCStep == lcStep_Development)
                        {
                            if (isChecked)
                            {
                                ...
                                {
                                    mailToAdmins += string.Format("При переводе {0} на шаг 'Согласование и утверждение' возникла системная ошибка: \r\n" +
                                    "Источник: {1}; \r\n" +
                                    "Сообщение: {2}; \r\n",
        ...
        {
            SendMessage(activity, UserSession, mailToAdmins, "Ошибка согласования технологических ИИ");
        }
    }
}